...
-- ── 12. Resume Embeddings Table (pgvector) ───────────────────────────────────────
...
CREATE INDEX IF NOT EXISTS "idx_resume_embeddings_vector" ON "resume_embeddings" USING hnsw ("embedding" vector_cosine_ops);
